...
int CRDT::comparePosdx(std::vector<int> curSymPos, std::pair<int, int> curSymId,
...
int CRDT::comparePos(std::vector<int> curSymPos, std::pair<int, int> curSymId, std::vector<int> newSymPos,
